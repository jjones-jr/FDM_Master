...
C       ---Plasminogenesis-related constants
     ...
     &              H1,H1_m,
C       ---Boundary Condition parameters (Endothelial)
     &              PHI_AP,PHI_IXA,PHI_XA,PHI,
     &              PHI_C_TPA,PHI_IIA_TPA,PHI_IA,TPA,
     &              SUBENDO,ENDO     
...
C--Boundary Condition parameters (Anand,2003,pp.205)
C-- phi_IIa_tPa = 4.61*10^-6*e^{-134.8(t-T0)} [m]
C--  Note: T0 refers to the instant when thrombin concentration
C--        on the boundry becomes non-zero. t,T0 are in "seconds".
      PHI_AP=2.53D8
      PHI_C_TPA=2.17D-7
      PHI_IIA_TPA=4.61D-6
      PHI_IA_TPA=1.68D-12
